// code for reuseum educational touch screen robot an exploration into codeing wifi javascript and html 
// add to additional boards if missing esp boards (https://arduino.esp8266.com/stable/package_esp8266com_index.json)
...
// javascript for touch joystick from github.com/jeromeetienne
...
void handleJSData(){
 ...
 /* aSpeed = map(aSpeed + x/2,0,1023, 0, 250);
  ...
  aSpeed = constrain(aSpeed + x/2, 0, 250);
  bSpeed = constrain(bSpeed - x/2, 0, 250);
//aSpeed/=2.0;
//bSpeed /=2.0;
